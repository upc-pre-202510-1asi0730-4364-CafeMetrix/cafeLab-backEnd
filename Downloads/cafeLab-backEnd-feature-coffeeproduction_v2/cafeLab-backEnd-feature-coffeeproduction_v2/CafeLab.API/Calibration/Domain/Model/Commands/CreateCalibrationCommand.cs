...
/// <summary>
/// Command to create a new calibration
/// </summary>
...
public record CreateCalibrationCommand(string EquipmentName, string EquipmentType, string CalibrationMethod, decimal TargetValue, decimal MeasuredValue, decimal Tolerance, string Status, string Notes, DateTime CalibrationDate, DateTime NextCalibrationDate, int UserId); 