...
/// <summary>
/// Command to update an existing calibration
/// </summary>
/// <param name="Id">ID of the calibration to update</param>
...
public record UpdateCalibrationCommand(int Id, string EquipmentName, string EquipmentType, string CalibrationMethod, decimal TargetValue, decimal MeasuredValue, decimal Tolerance, string Status, string Notes, DateTime CalibrationDate, DateTime NextCalibrationDate); 