...
{
    // Repositorio para operaciones CRUD del módulo de calibraciones (calibrations)
    // Implementa la lógica de acceso a la base de datos para calibraciones.
    // Utilizado por los servicios y controladores para manipular datos de calibraciones.
    //
