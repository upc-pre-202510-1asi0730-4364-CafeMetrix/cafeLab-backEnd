...
{
    /// <summary>
    /// Entidad principal para el módulo de calibraciones (calibrations)
    /// Define los atributos y relaciones de las calibraciones de equipos o procesos.
    /// Permite el registro, consulta, actualización y eliminación de calibraciones.
    /// Relacionado con el CRUD de calibraciones en la API y el frontend.
    /// </summary>
