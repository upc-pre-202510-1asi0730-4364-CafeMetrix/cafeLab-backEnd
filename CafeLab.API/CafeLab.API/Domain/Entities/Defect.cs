...
/// </summary>
// Entidad principal para el módulo de defectos (defects)
// Define los atributos y relaciones de los defectos de café.
// Permite el registro, consulta, actualización y eliminación de defectos.
// Relacionado con el CRUD de defectos en la API y el frontend.
//
public class Defect
{
    /// <summary>
